...
const Appeals = (props) => {
    ...
    useEffect(() => {
        axios.get('https://sheet2api.com/v1/7Hp4qy9eQpGr/jobly')
            .then(res => {
                setData(res.data)
                                ...
                                <div className='row'>
                                    <div className='col-md-9 col-sm-6 col-lg-12 d-flex mb-3 justify-content-between'>
                                        ...
                                        <div className='searchJob mb-5' style={{ alignItems: 'center', display: 'flex', top: '20px' }}>
                                            <input className='searchBar mt-2 p-2' onChange={event => console.log(setQuery(event.target.value))} type='text' />
